...
vim.g.have_nerd_font = os.getenv 'USE_NERD' == '1'
...
vim.opt.tabstop = 4 -- The width of a standard tab character
vim.opt.shiftwidth = 4 -- The width used for indentation (>> and <<)
